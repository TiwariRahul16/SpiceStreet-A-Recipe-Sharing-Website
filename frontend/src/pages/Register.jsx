...
//                   <input type="email" class="form-control" name="Name" id="Name" placeholder=" Name" required />
//                 </div>
//                 <div class="col-12">
...
//                 </div>
//                 <div class="col-12">
//                   <label for="Conformpassword" class="form-label">Conform Password <span class="text-danger">*</span></label>
...
//                       I agree to the <Link href="#!" class="link-primary text-decoration-none">terms and conditions</Link>
//                     </label>
//                   </div>
//                 </div> */}
//                 <div class="col-12">
